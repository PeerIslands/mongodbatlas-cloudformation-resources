...
var CreateRequiredFields = []string{"GroupId", "Links", "ApiKeys.PrivateKey", "ApiKeys.PublicKey"}
...
func Create(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	/*
	   ...
	   Links, ApiKeys, GroupId, Id, BucketName, CloudProvider, IamRoleId, ...
	*/
	/*
	    // Pseudocode:
	    res , resModel, err := client.CloudBackupSnapshotExportBucket.Create(context.Background(),&mongodbatlas.CloudBackupSnapshotExportBucket{
...
func Read(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	/*
	   Considerable params from currentModel:
	   GroupId, ExportBucketId, ...
	*/
	/*
	    // Pseudocode:
	    res , resModel, err := client.CloudBackupSnapshotExportBucket.Read(context.Background(),&mongodbatlas.CloudBackupSnapshotExportBucket{
	   	GroupId:currentModel.GroupId,
...
func Update(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	/*
	    // Pseudocode:
	    res , resModel, err := client.CloudBackupSnapshotExportBucket.Update(context.Background(),&mongodbatlas.CloudBackupSnapshotExportBucket{
	   })
...
func Delete(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	*/
	/*
	    // Pseudocode:
	    res , resModel, err := client.CloudBackupSnapshotExportBucket.Delete(context.Background(),&mongodbatlas.CloudBackupSnapshotExportBucket{
	   	GroupId:currentModel.GroupId,
	   	ExportBucketId:currentModel.ExportBucketId,
	   })
...
func List(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	/*
	    // Pseudocode:
	    res , resModel, err := client.CloudBackupSnapshotExportBucket.List(context.Background(),&mongodbatlas.CloudBackupSnapshotExportBucket{
	   })
