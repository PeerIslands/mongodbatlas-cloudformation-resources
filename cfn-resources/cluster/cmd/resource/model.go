...
type Model struct {
	...
	AnalyticsAutoScaling     *AnalyticsAutoScaling `json:",omitempty"`
...
// AnalyticsAutoScaling is autogenerated from the json schema
...
type ReplicationSpec struct {
	ID            *string        `json:",omitempty"`
	NumShards     *int           `json:",omitempty"`
	RegionsConfig []RegionConfig `json:",omitempty"`
	ZoneName      *string        `json:",omitempty"`
}

// RegionConfig is autogenerated from the json schema
type RegionConfig struct {
	AutoScaling    *AnalyticsAutoScaling `json:",omitempty"`
