...
func Create(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	/*
	   ...
	   Links, Port, BindPassword, Hostname, BindUsername, Hostname, Links, Port, Request, RequestId, Validations, AuthzQueryTemplate, BindUsername, CaCertificate, ApiKeys, GroupId, Status, ...
	*/
	/*
	    // Pseudocode:
	    res , resModel, err := client.LDAPVerify.Create(context.Background(),&mongodbatlas.LDAPVerify{
	   	Links:currentModel.Links,
	   	Port:currentModel.Port,
	   	BindPassword:currentModel.BindPassword,
	   	Hostname:currentModel.Hostname,
	   	BindUsername:currentModel.BindUsername,
	   	Hostname:currentModel.Hostname,
	   	Links:currentModel.Links,
	   	Port:currentModel.Port,
	   	Request:currentModel.Request,
	   	RequestId:currentModel.RequestId,
	   	Validations:currentModel.Validations,
	   	AuthzQueryTemplate:currentModel.AuthzQueryTemplate,
	   	BindUsername:currentModel.BindUsername,
	   	CaCertificate:currentModel.CaCertificate,
