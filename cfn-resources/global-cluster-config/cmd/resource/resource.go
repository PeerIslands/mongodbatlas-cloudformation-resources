...
var ReadRequiredFields = []string{"ApiKeys.PrivateKey", "ApiKeys.PublicKey"}
var UpdateRequiredFields = []string{"ApiKeys.PrivateKey", "ApiKeys.PublicKey"}
var DeleteRequiredFields = []string{"ClusterName", "GroupId", "ApiKeys.PrivateKey", "ApiKeys.PublicKey"}
...
func setup() {
	util.SetupLogger("mongodb-atlas-GlobalClusterConfig")
}
...
func Create(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	/*
	    // Pseudocode:
	    res , resModel, err := client.GlobalClusterConfig.Create(context.Background(),&mongodbatlas.GlobalClusterConfig{
	   })
...
func Read(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	/*
	    // Pseudocode:
	    res , resModel, err := client.GlobalClusterConfig.Read(context.Background(),&mongodbatlas.GlobalClusterConfig{
	   })
...
func Update(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	/*
	    // Pseudocode:
	    res , resModel, err := client.GlobalClusterConfig.Update(context.Background(),&mongodbatlas.GlobalClusterConfig{
	   })
...
func Delete(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	*/
	/*
	    // Pseudocode:
	    res , resModel, err := client.GlobalClusterConfig.Delete(context.Background(),&mongodbatlas.GlobalClusterConfig{
...
func List(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	/*
	    // Pseudocode:
	    res , resModel, err := client.GlobalClusterConfig.List(context.Background(),&mongodbatlas.GlobalClusterConfig{
	   })
