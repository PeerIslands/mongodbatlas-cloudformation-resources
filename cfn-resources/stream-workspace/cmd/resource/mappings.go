...
// newCFNModelFromStreamWorkspace is kept for backward compatibility
// Deprecated: Use GetStreamWorkspaceModel instead
func newCFNModelFromStreamWorkspace(prevModel *Model, streamTenant admin.StreamsTenant) *Model {
	return GetStreamWorkspaceModel(&streamTenant, prevModel)
}
