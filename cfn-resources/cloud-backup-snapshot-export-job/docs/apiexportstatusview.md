...
<pre>
{
    ...
    "<a href="#exportedcollections" title="ExportedCollections">ExportedCollections</a>" : <i>String</i>,
    "<a href="#totalcollections" title="TotalCollections">TotalCollections</a>" : <i>String</i>
}
</pre>
